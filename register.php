...
<div class="article">
    <h2>Register</h2>
    <div>
		<form method="POST" action="?op=register_1" role="form">
			<div class="form-group">
				...
				<input type="password" class="form-control" name="pwd_again" id="pwd_again" placeholder="Password again">
			</div>
  			<input type="submit" value="Submit" class="btn"/>
  			<input type="reset" value="Clear" class="btn"/>
            <a class="btn" href="?op=login" >Login</a>
  		</form>
 	</div>
</div>
